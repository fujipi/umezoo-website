...
const jobData = {
  1: {
    ...
    body: `
      ...
      <ul>
        ...
        <li>アライアンス先の開拓・関係構築・協業スキームの設計</li>
        <li>プロジェクト全体のプロデュースおよび社内外のリソース調整</li>
        <li>クライアントとの継続的なリレーション構築と追加提案</li>
      </ul>
      <h3>求める経験・スキル</h3>
      <ul>
        <li>事業会社またはコンサルティングファームでの事業企画・経営企画経験</li>
        <li>アライアンス・パートナーシップ構築の経験</li>
  ...
  3: {
    ...
    body: `
      <h3>主な業務内容</h3>
      <ul>
        <li>法人営業チームのマネジメントおよびメンバー育成</li>
        <li>売上目標・KPIの策定と進捗管理</li>
        <li>重要クライアントとのリレーション構築と大型案件のリード</li>
        <li>営業戦略の立案と実行、マーケティング部門との連携</li>
        <li>経営陣への営業実績報告と事業戦略への提言</li>
      </ul>
      <h3>求める経験・スキル</h3>
      <ul>
        <li>法人営業における5年以上の経験、うちマネジメント経験2年以上</li>
        <li>チームの売上目標達成に向けた戦略立案・実行経験</li>
        <li>経営層との折衝・レポーティング経験</li>
        <li>食品・クリエイティブ業界の知識（尚可）</li>
      </ul>
      <h3>求める人物像</h3>
      <ul>
        <li>チームの成果を最大化することにコミットできる方</li>
        <li>自ら率先して動きながらメンバーの成長も支援できる方</li>
        <li>変化の多い環境で柔軟に対応し、成果を出せる方</li>
      </ul>
      <h3>待遇</h3>
      <p>詳細はオファー時にご提示します。共通条件は本ページ下部「福利厚生・共通条件」をご確認ください。</p>
    `
  ...
  5: {
    ...
    body: `
      ...
      <ul>
        ...
        <li>マーケティング戦略の立案と実行</li>
        <li>SNS・Web・広告等のデジタルマーケティング施策の企画・運用</li>
        <li>ブランドコンセプト・ポジショニングの設計</li>
        <li>KPI設計と効果測定、改善提案</li>
      </ul>
      <h3>求める経験・スキル</h3>
      <ul>
        <li>マーケティング実務経験（デジタル/オフライン問わず）</li>
        <li>データ分析に基づく施策立案・改善の経験</li>
        <li>食品・飲食業界の知識（尚可）</li>
      ...
      <ul>
        ...
        <li>クリエイティブとロジックの両面でアウトプットを出せる方</li>
  ...
  7: {
    ...
    type: '正社員 / 業務委託',
    location: 'ハイブリッド',
    role: '新規事業の立案・推進や既存事業の成長戦略を企画し、実行まで一気通貫で担う',
    body: `
      <h3>主な業務内容</h3>
      <ul>
        <li>新規事業のアイデア創出、市場検証（MVP構築）</li>
        <li>事業計画の策定とKPI設計</li>
        <li>パートナー企業との協業スキーム構築</li>
        <li>プロダクト開発、マーケティング、オペレーション全般の推進</li>
        <li>経営陣への進捗報告と意思決定サポート</li>
      </ul>
      <h3>求める経験・スキル</h3>
      <ul>
        <li>新規事業立ち上げまたは事業企画の経験</li>
        <li>P/L管理、プロジェクトマネジメントの経験</li>
  ...
  8: {
    ...
    type: '正社員',
    location: '東京',
    role: '食とクリエイティブへの情熱を持ち、UMEZOOの成長を共に創るポテンシャル採用',
    body: `
      <h3>募集概要</h3>
      <p>UMEZOOでは、食とクリエイティブに情熱を持つ若手人材を積極的に採用しています。特定の職種に限定せず、適性と志向に応じてポジションをご提案します。</p>
      <h3>こんな方を歓迎します</h3>
      <ul>
        <li>食・飲食・フードビジネスに強い関心がある方</li>
        <li>クリエイティブな仕事に興味があり、手を動かすのが好きな方</li>
        <li>スタートアップの環境で成長したい方</li>
        <li>チームワークを大切にし、主体的に動ける方</li>
      </ul>
      <h3>入社後のキャリア</h3>
      <ul>
        <li>OJTを中心とした実践的な研修プログラム</li>
        <li>複数プロジェクトへのアサインを通じた幅広い経験</li>
        <li>適性に応じたキャリアパスの設計（セールス、プランニング、マーケティング等）</li>
      </ul>
      <h3>待遇</h3>
      <p>詳細はオファー時にご提示します。共通条件は本ページ下部「福利厚生・共通条件」をご確認ください。</p>
    `
  ...
  9: {
    ...
    type: '正社員 / 業務委託',
    location: '東京 / ハイブリッド',
    role: '上記に当てはまらないスキル・経験をお持ちの方もぜひご応募ください',
    body: `
      <h3>募集概要</h3>
      <p>UMEZOOでは、掲載中のポジション以外にも、事業拡大に伴い様々な職種での採用を検討しています。「自分のスキルがUMEZOOで活かせるかもしれない」と感じた方は、ぜひお気軽にご応募ください。</p>
      <h3>こんな方を歓迎します</h3>
      <ul>
        <li>食・フードビジネス領域での専門的なスキル・経験をお持ちの方</li>
        <li>クリエイティブ制作（映像、デザイン、写真等）の経験がある方</li>
        <li>テクノロジー（Web開発、データ分析等）のスキルを食領域で活かしたい方</li>
        <li>バックオフィス（経理、法務、総務等）の経験を持つ方</li>
      </ul>
      <h3>選考プロセス</h3>
      <ul>
        <li>カジュアル面談でご経験やご志向をお伺いします</li>
        <li>適性に応じたポジションをご提案します</li>
        <li>通常の選考フローに進んでいただきます</li>
      </ul>
      <h3>待遇</h3>
      <p>詳細はオファー時にご提示します。共通条件は本ページ下部「福利厚生・共通条件」をご確認ください。</p>
    `

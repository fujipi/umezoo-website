...
const translations = {
  ja: {
    ...
    about: {
      ...
      founderBio3: '「食べる」という行為が、単なるお腹を満たす目的を超えて、記憶に残る体験を作り得ることから、食体験をデザインすることをミッションに掲げ、フードビジネスの新しい可能性を追求し続けている。',
  ...
  en: {
    ...
    about: {
      ...
      founderBio3: 'Believing that the act of eating can go beyond merely satisfying hunger to create truly memorable experiences, he has made it his mission to design food experiences, and continues to pursue new possibilities in food business.',
      valuesTitle: 'Our Values',
  ...
  fr: {
    ...
    about: {
      ...
      founderBio3: 'Convaincu que l\'acte de manger peut dépasser le simple fait de se rassasier pour créer des expériences véritablement mémorables, il s\'est donné pour mission de concevoir des expériences alimentaires et continue de poursuivre de nouvelles possibilités dans le secteur alimentaire.',

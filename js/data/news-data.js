...
const newsData = {
  1: {
    ...
    summary: 'フードクリエイティブファームとして、UMEZOO株式会社を設立いたしました。創造的な食体験を事業活動に浸透させることをミッションに掲げ、活動を開始いたします。',
    slug: 'founding',
...
<p>今後ともUMEZOOをよろしくお願いいたします。</p>`
  ...
  2: {
    ...
    summary: 'UMEZOOの公式ウェブサイトを公開いたしました。私たちのサービス、実績、そしてフードクリエイティブに対する想いをご覧いただけます。',
    slug: 'website-launch',
...
<p>プロジェクトのご相談、業務提携のお問い合わせなど、お気軽にご連絡ください。</p>`
  ...
  3: {
    ...
    summary: 'RED U-35シルバーエッグ受賞シェフである代表・梅津信吾が、UMEZOO設立の背景と、フードクリエイティブが切り拓く新しい食体験について語ります。',
...
<p>「UMEZOOとして、食の可能性をさらに広げていきたいと考えています。国内だけでなく海外の案件にも積極的に取り組み、日本の食文化の素晴らしさを世界に発信していく。そんな架け橋になれたら嬉しいです。」</p>`
  ...
  4: {
    ...
    summary: '東京にて、山形の料理とワインによる新たな食体験を発信するコラボイベント「YAMAGATA FUSION」を開催。高畠ワイナリー協力のもと実現しました。',
    slug: 'yamagata-fusion',
...
<p><a href="https://www.redu35.jp/clubred/report/11301/" target="_blank" rel="noopener noreferrer">イベントレポートはこちら →</a></p>`
  ...
  5: {
    ...
    summary: '三井不動産様の飲食事業者共創プラットフォーム「&mog」にて、消費者向け食品プロモーションにおけるクリエイティブ制作ワークショップを共催しました。',
    slug: 'andmog-workshop',
...
<p><a href="https://www.and-mog.com/assets/data/magazine-20240510_ja.pdf" target="_blank" rel="noopener noreferrer">詳細資料はこちら →</a></p>`
  ...
  6: {
    ...
    summary: '福島県大熊町の農業再生プロジェクト「Fun Eat Makers in Okuma」に参画。「つくる・たべる・つながる」をコンセプトに農業と食の拠点創出に取り組んでいます。2025年6月ローンチ予定。',
    slug: 'fun-eat-makers',
...
<p><a href="https://www.cri.co.jp/news/005713.html" target="_blank" rel="noopener noreferrer">プロジェクト詳細はこちら →</a></p>`
  ...
  7: {
    ...
    title: '「AI Film Hackathon in Tokyo」に参加、約30チーム中の上位3作品に選出',
    image: 'images/news/ai-film-hackathon.jpg',
    summary: '2026年7月19日に川崎で開催された生成AIによる映像制作ハッカソン「AI Film Hackathon in Tokyo」に代表・梅津信吾が参加。当日結成した多国籍チームで短編映像を制作し、約30チーム中の上位3作品に選出されました。',
    slug: 'ai-film-hackathon-tokyo',
    body: `<p>2026年7月19日、神奈川県川崎市で開催された「AI Film Hackathon in Tokyo」に、代表・梅津信吾が参加いたしました。約30チームが制作した作品の中から上位3作品に選出され、上映後には会場からスタンディングオベーションをいただきました。</p>
<p><strong>イベント概要</strong></p>
<p>・日時：2026年7月19日（日）10:00〜20:00<br>
・会場：神奈川県川崎市<br>
・主催：AIMovie.Studio、Tokyo AI、Global Stage Hollywood<br>
・協賛：Floyo、Cloud Ace<br>
・内容：当日結成したチームで生成AIツールを用いた短編映像を制作し、上映・審査までを行う一日完結型のハッカソン</p>
<p>映像生成にはスポンサーであるFloyoのプラットフォームを使用しました。ブラウザ上でComfyUIのワークフローを動かしながら、企画から書き出しまでを約9時間で完走しています。</p>
<p><strong>3か国のメンバーによる即席チーム</strong></p>
<p>チームは当日その場で結成した3名編成です。フランスから参加した16歳の高校生、ロボット工学を専門とするペルー出身のメンバー、そしてUMEZOOの梅津の3名で、以下のように役割を分担しました。</p>
<p>・テーマ・コンセプト設計：フランスの高校生メンバー<br>
・映像設計（構成・ビジュアルディレクション）：ペルー出身のメンバー<br>
・実装・編集・音楽：梅津信吾</p>
<p><strong>作品テーマ「仮面」</strong></p>
<p>制作した短編のテーマは「仮面」です。</p>
<p>人は誰しも、相手によって違う顔を使い分けています。それ自体は問題ではありません。けれど仮面を重ねすぎたとき、どれが本当の自分だったのか思い出せなくなる瞬間——アビス（深淵）——が訪れます。そしてその瞬間に手を差し伸べてくれるのは、いちばん意外な人物。かつて「仮面を持たない人」だと見下していた、あの人でした。</p>
<p>これは特別な誰かの物語ではなく、世界のどこかで、今この瞬間にも起きていること。その普遍性を、言語も世代も専門も異なる3名で議論を重ねながら、一本の映像に落とし込みました。</p>
<p><strong>代表・梅津信吾のコメント</strong></p>
<p>「このテーマを出したのが16歳の高校生だったことに、正直いちばん驚かされました。国籍も年齢も専門もばらばらの3人が、その場で役割を決めて9時間で一本を仕上げる。生成AIが制作のスピードを変えたからこそ成立するチームのつくり方だと感じています。</p>
<p>UMEZOOは映像やBGMを含むコンテンツデリバリーを事業の柱のひとつにしています。今回得たAI活用の実践知は、お客様への提供価値としてそのまま還元してまいります。」</p>
<p><strong>今後について</strong></p>
<p>本ハッカソンの上位作品は、2026年10月にハリウッドで開催される「Global Stage Hollywood」において、TCLチャイニーズ・シアターでの上映が予定されています。</p>
<p>ご一緒したチームメンバーの皆様、運営・協賛の皆様に、心より御礼申し上げます。UMEZOOは今後も、クリエイティブとテクノロジーの交差点に立ち続けてまいります。</p>
<p><a href="https://luma.com/ozjlktwq" target="_blank" rel="noopener noreferrer">イベント詳細はこちら →</a></p>`
  }
};

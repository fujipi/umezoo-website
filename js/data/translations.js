...
const translations = {
  ja: {
    ...
    service: {
      pageTitle: 'Service',
      pageSubtitle: '4つの領域で、パートナーの事業を動かす',
      ...
      expandSectionTitle: 'ひろげる',
      expandBody: 'コンセプト設計から事業計画、物件選定、店舗設計・施工、厨房設計、メニュー開発、オペレーション構築まで、店舗に限らず新規事業に関する一切を支援します。ローンチ後は運営支援として「つくる」「とどける」のサービスと接続し、継続的な事業成長を伴走します。',
      ...
      operateSectionTitle: 'まわす',
      operateBody: 'ローンチ後の事業を持続的に成長させるため、売上・顧客データの分析、メニュー・商品の定期改善、スタッフ教育、品質管理体制の維持・改善など、日々の事業運営を回し続ける伴走型の支援を提供します。',
      operate1Title: '売上・KPI分析・改善提案', operate1Desc: 'データに基づく月次レビューと改善アクション',
      operate2Title: 'メニュー・商品の定期リニューアル', operate2Desc: '季節やトレンドに応じた改廃・ブラッシュアップ',
      operate3Title: 'スタッフ教育・オペレーション改善', operate3Desc: '調理・接客・衛生のトレーニング設計と実施',
      operate4Title: '品質管理・衛生管理体制の維持', operate4Desc: 'HACCP運用、定期監査、改善フロー構築',
      operate5Title: '顧客満足度調査・VOC分析', operate5Desc: 'アンケート設計・集計・施策への反映',
      operate6Title: '月次レポート・経営会議支援', operate6Desc: 'KPIダッシュボード作成と改善提案',
  ...
  en: {
    ...
    service: {
      pageTitle: 'Service',
      pageSubtitle: 'Four domains that drive your partner\'s business',
      ...
      operateSectionTitle: 'Operate',
      operateBody: 'To sustain growth after launch, we provide ongoing operational support — from sales and customer data analysis, periodic menu and product improvements, staff training, to maintaining quality control systems. We keep the business engine running as your long-term partner.',
      operate1Title: 'Sales & KPI Analysis', operate1Desc: 'Data-driven monthly reviews and improvement actions',
      operate2Title: 'Periodic Menu & Product Renewal', operate2Desc: 'Seasonal updates and trend-based refinements',
      operate3Title: 'Staff Training & Operations Improvement', operate3Desc: 'Cooking, service, and hygiene training design and execution',
      operate4Title: 'Quality & Hygiene Management', operate4Desc: 'HACCP operations, regular audits, and improvement workflows',
      operate5Title: 'Customer Satisfaction & VOC Analysis', operate5Desc: 'Survey design, aggregation, and actionable insights',
      operate6Title: 'Monthly Reports & Management Meeting Support', operate6Desc: 'KPI dashboards and strategic improvement proposals',
  ...
  fr: {
    ...
    service: {
      pageTitle: 'Service',
      pageSubtitle: 'Quatre domaines pour faire avancer l\'activité de nos partenaires',
      ...
      operateSectionTitle: 'Opérer',
      operateBody: 'Pour soutenir la croissance après le lancement, nous fournissons un accompagnement opérationnel continu — de l\'analyse des ventes et des données clients, à l\'amélioration périodique des menus et produits, en passant par la formation du personnel et le maintien des systèmes de contrôle qualité. Nous faisons tourner le moteur de votre activité en tant que partenaire de long terme.',
      operate1Title: 'Analyse des ventes et KPI', operate1Desc: 'Revues mensuelles basées sur les données et actions d\'amélioration',
      operate2Title: 'Renouvellement périodique des menus et produits', operate2Desc: 'Mises à jour saisonnières et ajustements tendance',
      operate3Title: 'Formation du personnel et amélioration des opérations', operate3Desc: 'Conception et exécution de formations cuisine, service et hygiène',
      operate4Title: 'Gestion de la qualité et de l\'hygiène', operate4Desc: 'Opérations HACCP, audits réguliers et flux d\'amélioration',
      operate5Title: 'Enquêtes de satisfaction client et analyse VOC', operate5Desc: 'Conception d\'enquêtes, agrégation et mise en action',
      operate6Title: 'Rapports mensuels et support réunions de direction', operate6Desc: 'Tableaux de bord KPI et propositions d\'amélioration stratégique',
